# CUDA_VISIBLE_DEVICES=0 python expr_vis/new_mask/mask_acid.py /home/xinyang/Data/intattack/rev1/benign_maps/mask_v2_resnet50_benign/fold_1.npz /home/ningfei/xinyang/data_mask/acid_resnet_mask/fold_1.npz
...
# CUDA_VISIBLE_DEVICES=3 python rev1/mask_v2/mask_attack_acid_alt.py /home/xinyang/Data/intattack/fixup1/densenet_data/fold_1.npz /home/xinyang/Data/intattack/rev1/benign_maps/mask_v2_densenet169_benign/fold_1.npz densenet169 ../data_mask/acid_densenet_mask/fold_1.npz -b 34
# CUDA_VISIBLE_DEVICES=1 python rev1/mask_v2/mask_attack_acid_alt.py /home/xinyang/Data/intattack/fixup1/densenet_data/fold_2.npz /home/xinyang/Data/intattack/rev1/benign_maps/mask_v2_densenet169_benign/fold_2.npz densenet169 ../data_mask/acid_densenet_mask/fold_2.npz -b 34
# CUDA_VISIBLE_DEVICES=0 python rev1/mask_v2/mask_attack_acid_alt.py /home/xinyang/Data/intattack/fixup1/densenet_data/fold_3.npz /home/xinyang/Data/intattack/rev1/benign_maps/mask_v2_densenet169_benign/fold_3.npz densenet169 ../data_mask/acid_densenet_mask/fold_3.npz -b 20
...
vis = visdom.Visdom(env='mask_resnet_fold_1', port=7778)
...
def main(config):
    ...
    vis_steps = [400]
    arrs_imgs = [dobj_mask_adv['pgd_s2_step_%d_adv_x' % vis_step].copy() for vis_step in vis_steps]
    arrs_flags = [dobj_mask_adv['pgd_s2_step_%d_succeed' % vis_step].copy() for vis_step in vis_steps]
    arrs_masks = [dobj_mask_adv['pgd_s2_step_%d_adv_mask_mnow_disc' % vis_step].copy() for vis_step in vis_steps]
