# CUDA_VISIBLE_DEVICES=0 python expr_vis/vis_mask.py /home/xinyang/Data/intattack/rev1/target_maps/mask_resnet50/fold_2.npz /home/ningfei/xinyang/data_fix1/target/mask_resnet50/fold_2.npz
...
# python expr_vis/vis_isic_mask.py /home/xinyang/Data/intattack/rev1/benign_maps/isic_mask_benign/fold_1.npz /home/ningfei/xinyang/data_mask/isic_mask.npz
...
vis = visdom.Visdom(env='skin_mask', port=7777)
...
def main(config):
    ...
    # tar_img = dobj_mask_benign['target_images'].copy()
