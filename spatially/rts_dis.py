...
path_val = ['/home/xinyang/Data/intattack/rev1/regular_stadv_maps/rts_densenet169/fold_2.npz','/home/xinyang/Data/intattack/rev1/regular_stadv_maps/rts_densenet169/fold_3.npz']
...
#         con_acid.append(pro(acid[i]['pgd_s2_step_1200_adv_logits'][j].copy()))
        b_a.append(val[i]['stadv_rts_yt'][j].copy())
