...
#CUDA_VISIBLE_DEVICES=0 python spatially/cam_vis.py /home/xinyang/Data/intattack/rev1/acid_stadv_maps/cam_resnet50_benign/fold_1.npz

# CUDA_VISIBLE_DEVICES=0 python spatially/cam_vis.py /home/xinyang/Data/intattack/rev1/acid_stadv_maps/cam_densenet169_benign/fold_2.npz
...
vis = visdom.Visdom(env='st_cam_acid_densenet', port=7778)
...
def main(config):
    ...
    img_x, img_y, img_yt = dobj_cam_adv['img_x'].copy(), dobj_cam_adv['img_x'].copy(), dobj_cam_adv['img_x'].copy()

    cam_benign_y = dobj_cam_adv['cam_benign_y_n'].copy()
