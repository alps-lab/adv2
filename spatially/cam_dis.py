...
path_val = ['/home/xinyang/Data/intattack/rev1/acid_stadv_maps/cam_resnet50_benign/fold_1.npz','/home/xinyang/Data/intattack/rev1/acid_stadv_maps/cam_resnet50_benign/fold_2.npz','/home/xinyang/Data/intattack/rev1/acid_stadv_maps/cam_resnet50_benign/fold_3.npz']
...
path_acid = ['/home/xinyang/Data/intattack/rev1/regular_stadv_maps/cam_resnet50/fold_1.npz','/home/xinyang/Data/intattack/rev1/regular_stadv_maps/cam_resnet50/fold_2.npz','/home/xinyang/Data/intattack/rev1/regular_stadv_maps/cam_resnet50/fold_3.npz']
...
tt = []
for i in range(len(path_val)):
    for j in range(len(acid[i]['stadv_cam_yt_n'])):
        c2 += 1
...
#         con_acid.append(pro(acid[i]['pgd_s2_step_1200_adv_logits'][j].copy()))
        b_a.append(val[i]['cam_benign_y_n'][j].copy())
        a.append(acid[i]['stadv_cam_yt_n'][j].copy())
