...
# path_val = ['/home/xinyang/Data/intattack/fixup1/resnet50_mask/fold_1.npz','/home/xinyang/Data/intattack/fixup1/resnet50_mask/fold_2.npz','/home/xinyang/Data/intattack/fixup1/resnet50_mask/fold_3.npz']

path_val = ['/home/xinyang/Data/intattack/rev1/regular_stadv_maps/mask_v2_densenet169/fold_1.npz','/home/xinyang/Data/intattack/rev1/regular_stadv_maps/mask_v2_densenet169/fold_2.npz']
path_acid = ['/home/xinyang/Data/intattack/rev1/acid_stadv_maps/mask_densenet169_benign/fold_1.npz','/home/xinyang/Data/intattack/rev1/acid_stadv_maps/mask_densenet169_benign/fold_2.npz']
...
# path_acid = ['/home/xinyang/Data/intattack/rev1/regular_stadv_maps/mask_v2_resnet50/fold_1.npz','/home/xinyang/Data/intattack/rev1/regular_stadv_maps/mask_v2_resnet50/fold_2.npz','/home/xinyang/Data/intattack/rev1/regular_stadv_maps/mask_v2_resnet50/fold_3.npz']
# path_acid = ['/home/xinyang/Data/intattack/rev1/regular_stadv_maps/mask_v2_resnet50/fold_1.npz','/home/xinyang/Data/intattack/rev1/regular_stadv_maps/mask_v2_resnet50/fold_2.npz']
tar = []
acid = []
val = []
reg = []
...
tt = []
for i in range(len(path_val)):
    for j in range(len(val[i]['stadv_mask_yt'])):
        c2 += 1
...
#         con_acid.append(pro(acid[i]['pgd_s2_step_1200_adv_logits'][j].copy()))
        b_a.append(acid[i]['mask_benign_y'][j].copy())
        a.append(val[i]['stadv_mask_yt'][j].copy())
