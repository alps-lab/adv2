...
path_val = ['/home/xinyang/Data/intattack/fixup1/resnet50_cam/fold_1.npz','/home/xinyang/Data/intattack/fixup1/resnet50_cam/fold_2.npz','/home/xinyang/Data/intattack/fixup1/resnet50_cam/fold_3.npz']
# path_val = ['/home/xinyang/Data/intattack/fixup1/densenet169_cam/fold_1.npz','/home/xinyang/Data/intattack/fixup1/densenet169_cam/fold_2.npz','/home/xinyang/Data/intattack/fixup1/densenet169_cam/fold_3.npz']
...
path_acid = ['/home/xinyang/Data/intattack/rev1/acid_stadv_maps/cam_resnet50_benign/fold_1.npz','/home/xinyang/Data/intattack/rev1/acid_stadv_maps/cam_resnet50_benign/fold_2.npz','/home/xinyang/Data/intattack/rev1/acid_stadv_maps/cam_resnet50_benign/fold_3.npz']

# path_acid = ['/home/xinyang/Data/intattack/rev1/regular_stadv_maps/cam_densenet169/fold_1.npz','/home/xinyang/Data/intattack/rev1/regular_stadv_maps/cam_densenet169/fold_2.npz','/home/xinyang/Data/intattack/rev1/regular_stadv_maps/cam_densenet169/fold_3.npz']
tar = []
acid = []
val = []
reg = []
...
tt = []
for i in range(len(path_val)):
    for j in range(len(acid[i]['s2_step_600_stadv_cam_n'])):
        c2 += 1
        if acid[i]['s2_step_600_stadv_succeed'][j] == 1:
...
#         con_acid.append(pro(acid[i]['pgd_s2_step_1200_adv_logits'][j].copy()))
            b_a.append(acid[i]['cam_benign_y_n'][j].copy())
            a.append(acid[i]['s2_step_600_stadv_cam_n'][j].copy())
