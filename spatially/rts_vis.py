...
#CUDA_VISIBLE_DEVICES=0 python spatially/rts_vis.py /home/xinyang/Data/intattack/fixup1/densenet_data/fold_3.npz /home/xinyang/Data/intattack/rev1/acid_stadv_maps/rts_densenet169_benign/fold_3.npz
...
vis = visdom.Visdom(env='st_rts_acid_den', port=7778)
...
def main(config):
    ...
    cam_benign_y = dobj_cam_adv['target_rts'].copy()
