...
# CUDA_VISIBLE_DEVICES=0 python spatially/mask_vis.py /home/xinyang/Data/intattack/rev1/acid_stadv_maps/mask_densenet169_benign/fold_2.npz
...
vis = visdom.Visdom(env='st_mask_acid_den', port=7778)
