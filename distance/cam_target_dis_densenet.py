...
path_val = ['/home/xinyang/Data/intattack/fixup1/densenet169_regular_pgd_cam/fold_1.npz','/home/xinyang/Data/intattack/fixup1/densenet169_regular_pgd_cam/fold_2.npz']

path_tar = ['/home/xinyang/Data/intattack/rev1/target_maps/cam_densenet169/fold_1.npz','/home/xinyang/Data/intattack/rev1/target_maps/cam_densenet169/fold_2.npz']

path_acid = ['/home/ningfei/xinyang/data_fix1/target/cam_densenet169/fold_1.npz', '/home/ningfei/xinyang/data_fix1/target/cam_densenet169/fold_2.npz']
...
tt = []
for i in range(len(path_val)):
    for j in range(len(acid[i]['pgd_s2_step_1200_adv_cam'])):
        c2 += 1
...
#             pgd_s2_step_300_adv_logits
            ...
            b_a.append(val[i]['pgd_step_1200_adv_cam_yt_n'][j].copy())
            a.append(acid[i]['pgd_s2_step_1200_adv_cam_n'][j].copy())
...
print('tar_val_cam_l1_dist:', np.mean(tar_val_l1_dist))
print('tar_val_cam_l1_dist_std:', np.std(tar_val_l1_dist))
print('tar_val_cam_l2_dist:', np.mean(tar_val_l2_dist))
print('tar_val_cam_l2_dist_std:', np.std(tar_val_l2_dist))
