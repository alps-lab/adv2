...
from expr_attacks.mask_generator import generate_mask_per_batch, get_default_mask_config
from expr_attacks.mask_model import MASK
...
def main(config):
    ...
    mask_model = MASK(config.is_cuda)
    ...
    for batch in loader:
        ...
        mask = generate_mask_per_batch(mask_config, mask_model, model_tup, (images, labels), config.is_cuda)
