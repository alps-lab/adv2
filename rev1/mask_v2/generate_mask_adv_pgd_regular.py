...
# python rev1/mask_v2/generate_mask_adv_pgd_regular.py /home/xinyang/Data/intattack/fixup1/resnet_data/fold_1.npz ~/data/data_resnet_2/mask_attack_pgd_vanilla_fold_resnet_1.npz
...
def main(config):
    ...
    for step, key in kept_keys.items():
        ...
        robj['pgd_step_%d_adv_mask_yt' % step] = generate_masks_v2(mask_config, model_tup, (img_x, img_yt),
                                                                   config.device == 'gpu')
