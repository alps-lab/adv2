...
def get_pretrained_saliency_fn(ckpt_dir, cuda=True, return_classification_logits=False):
    ...
    def saliency_fn(images, selectors, model_confidence=6):
        ...
        masks, _, cls_logits = saliency(imagenet_normalize(_images), _selectors, model_confidence=model_confidence)
    ...
    def logits_fn(images):
        ...
        logits = saliency.encoder(imagenet_normalize(_images))[-1]
        return logits
